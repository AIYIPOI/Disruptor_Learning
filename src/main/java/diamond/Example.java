...
public class Example {
	...
	public void startDisruptor() {
		...
		// 绑定消费者
		disruptor.handleEventsWith(new EventHandler[]{new Handler1(), new Handler2()}).then(new Handler3());
	...
	/** 处理事件，把结果加1 */
	class Handler1 implements EventHandler<IntegerEvent> {
		@Override
	...
	/** 处理事件，把结果加1 */
	class Handler2 implements EventHandler<IntegerEvent> {
		@Override
		public void onEvent(IntegerEvent event, long sequence, boolean endOfBatch) throws Exception {
	...
	/** 处理事件，把结果加1 */
	class Handler3 implements EventHandler<IntegerEvent> {
		@Override
		public void onEvent(IntegerEvent event, long sequence, boolean endOfBatch) throws Exception {
